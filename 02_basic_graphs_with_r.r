...
# Tema 2 R-base ejemplos de visualizacion 
...
plot(tons, 
     litperkm, 
     main = "Ejemplo grafico de dispersion",
...
scatterplot.matrix( ~ litperkm + disp + drat + tons | cyl, 
                    data = mtcars,
                    main = "Matriz de grafs dispersion por n cilindros")

# Nos da un warning! Que esta "deprecated" -obsoleto...
